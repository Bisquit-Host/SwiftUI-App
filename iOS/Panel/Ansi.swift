...
fileprivate let ansiToSwiftUIColorMap: [Int: Color] = [
...
public func convertAnsiToAttributedString(_ input: String) -> AttributedString {
                ...
                for code in colorCodes {
                    ...
                    default:
                        if let codeInt = Int(code) {
                            lastColor = ansiToSwiftUIColorMap[codeInt] ?? lastColor
                        }
                    }
                }
            }
    ...
    detectAndAddLinks(&attributedString)
    
    return attributedString
}

private func detectAndAddLinks(_ attributedString: inout AttributedString) {
