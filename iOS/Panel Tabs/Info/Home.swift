...
struct Home: View {
    ...
    @State var defaultBlurRadius = 0.0
    @State var defaultSaturationAmount = 0.0
    @State var activateGlassMorphism = true
...
//                    // Changing Blur Radius And Saturations
...
extension NSObject {
    ...
    func value(key: String, filter: String) -> NSObject? {
        (value(forKey: key) as? [NSObject])?.first { obj in
