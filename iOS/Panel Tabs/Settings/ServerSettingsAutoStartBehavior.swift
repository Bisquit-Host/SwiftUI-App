...
enum ServerSettingsAutoStartBehavior: String, CaseIterable, Identifiable {
    ...
    init(_ behavior: CalagopusServerAutoStartBehavior) {
        ...
        case .unlessStopped: self = .unlessStopped
    ...
    var calagopusValue: CalagopusServerAutoStartBehavior {
        switch self {
        case .always: .always
        case .unlessStopped: .unlessStopped
        case .never: .never
        }
    }
    ...
    var subtitle: LocalizedStringKey {
        switch self {
        case .always: "Start when the node boots"
        case .unlessStopped: "Start unless it was manually stopped"
        case .never: "Stay offline until started manually"
        }
    }
}
